...
class HrPayslip(models.Model):
    ...
    journal_id = fields.Many2one('account.journal',
                                 ...
                                 # sudo(): picking a sensible default
                                 # journal shouldn't require the current
                                 # user to personally have Accounting
                                 # access - only posting the resulting
                                 # move (action_payslip_done) needs that.
    ...
    def action_payslip_cancel(self):
        ...
        moves = self.mapped('move_id').sudo()
    ...
    def action_payslip_done(self):
        ...
        for slip in self:
            ...
            # sudo(): validating a payslip is a Payroll action: the user
            # doing it has already been authorized via their Payroll
            # group, and shouldn't also need personal Accounting/
            # Invoicing rights just because this module happens to post
            # a journal entry as a side effect.
