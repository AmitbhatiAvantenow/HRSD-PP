...
class TestWebReadGroup(common.TransactionCase):
    ...
    def test_groupby_with_blank_spec(self):
        Model = self.env["test_read_group.aggregate"]
        Model.create(
            [
                {"key": 1, "value": 1},
        ...
        self.assertEqual(
            ...
            {
                "groups": [
                    {"__extra_domain": [("key", "=", 1)], "key": 1, "__count": 2, "value:sum": 3},
                    {"__extra_domain": [("key", "=", 2)], "key": 2, "__count": 1, "value:sum": 3},
                    {"__extra_domain": [("key", "=", False)], "key": False, "__count": 1, "value:sum": 0},
                ],
                "length": 3,
            },
        )
